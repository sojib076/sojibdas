...
const Banner = () => {
    return (
        <div className="bg-black/90 text-gray-300 flex items-center
         lg:h-[80vh] py lg:px-10 px-2 lg:flex-row flex-col-reverse py-20 lg:py-36 "  id="home" >
            <div className="lg:w-[70%]">
                <h1 className="lg:text-[58px] text-[32px] font-extrabold font-[Rajdhani] "> Greetings <br /> <span className='
                text-green-600 font-[Rajdhani] '> I am Sojib Ds </span> </h1>
 ...
 <button className="px-6 py-2
                 bg-green-600 text-black font-semibold rounded hover:bg-green-600 transition-all hover:scale-110 hover:text-white">
                    Download CV
                </button>

               </a>
            </div>
            <div className="lg:w-[40%] relative transform h-[50vh] lg:h-auto mb-10 lg:mb-0 ">
                <img
                    src={sojibimg}
                    alt="Banner Background"
                    className="lg:w-[990px] w-full lg:h-[520px] object-cover mb-[-40px] "
                    style={{ width: '150%' }}
                />
                <div className="absolute lg:top-22 top-16 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
