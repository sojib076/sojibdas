  ...
  return (
    <div className='p-2'>
      <div className="flex flex-col items-center mb-5">
        {/* Skeleton for Frontend Skills */}
        <div className="bg-gray-300 rounded-lg p-6 lg:w-[450px] w-fu max-w-md shadow-md animate-pulse">
      ...
      <div className="flex justify-center lg:gap-8 gap-4">
        ...
        {Array.from({ length: 2 }).map((_, index) => (
          <div
            className="bg-gray-300 rounded-lg p-6 w-full shadow-md animate-pulse"
            key={index}
          >
